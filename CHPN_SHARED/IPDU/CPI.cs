...
namespace CHPN.IPDU
	...
	public class CPI: CRawdata, IPI
		...
		/// Throws Exceptions if buffer doesn't match PI size.
		/// </summary>
		/// <param name="buffer">Buffer to copy to the Data part</param>
		/// <param name="start">Start position inside the buffer</param>
		...
		/// </summary>
		/// <param name="index">Index of byte to change</param>
		/// <param name="b">Value to apply</param>
